...
def file_charge(filename1,filename2,name):
    plt.close("all")
...
#%% stats1 
    ...
    ct_vs_1_b = stts.mannwhitneyu(data_2[1], data_2[3])
    print(filename2 + " " + "ct_vs_1")
    print(data_2[1]) 
    print(data_2[3])
    print(ct_vs_1_b)
    ct_vs_7_b = stts.mannwhitneyu(data_2[1], data_2[5])
    print(filename2 + " " + "ct_vs_7")
    print(data_2[1]) 
    print(data_2[5])
    print(ct_vs_7_b)
    ct_vs_30_b = stts.mannwhitneyu(data_2[1], data_2[7])
    print(filename2 + " " + "ct_vs_30")
    print(data_2[1]) 
    print(data_2[7])
    print(ct_vs_30_b)
    
    ct_vs_ct = stts.mannwhitneyu(data_1[1], data_2[1])
    print("between" + " " + "ct_vs_ct")
    print(data_1[1]) 
    print(data_2[1])
    print(ct_vs_ct)
    one_one = stts.mannwhitneyu(data_1[3], data_2[3])
    print("between" + " " + "1_vs_1")
    print(data_1[3]) 
    print(data_2[3])
    print(one_one)
    seven_seven = stts.mannwhitneyu(data_1[5], data_2[5])
    print("between" + " " + "7_vs_7")
    print(data_1[5]) 
    print(data_2[5])
    print(seven_seven)
    
    thirty_thirty = stts.mannwhitneyu(data_1[7], data_2[7])
    print("between" + " " + "30_vs_30")
    print(data_1[5]) 
    print(data_2[5])
    print(thirty_thirty)
    #%%
    peva_1 = np.array([ct_vs_1.pvalue,ct_vs_7.pvalue,ct_vs_30.pvalue])
    print peva_1
    peva_2 = np.array([ct_vs_1_b.pvalue,ct_vs_7_b.pvalue,ct_vs_30_b.pvalue])
    print peva_2
    peva_3 = np.array([ct_vs_ct.pvalue,one_one.pvalue,seven_seven.pvalue,thirty_thirty.pvalue])
    print peva_3
    estats =  np.concatenate([peva_1,peva_2,peva_3])
    np.savetxt(name,estats, delimiter=',')